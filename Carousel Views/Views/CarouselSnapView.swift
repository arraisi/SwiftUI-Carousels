...
struct CarouselSnapView_Previews: PreviewProvider {
    static var previews: some View {
        CarouselSnapView(itemWidth: UIScreen.main.bounds.width-30, itemHeight: UIScreen.main.bounds.width*0.6, spacing: 20,
                         data: .constant([
