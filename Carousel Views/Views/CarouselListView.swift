...
struct CarouselListView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            self.firstItemPosition = offsetFirstItem - offsetMiddleItem - self.offset
        }
...
struct CarouselList2View_Previews: PreviewProvider {
    static var previews: some View {
        CarouselListView(itemWidth: UIScreen.main.bounds.width-150, itemHeight: UIScreen.main.bounds.width*0.6, offset: 50, spacing: 30,
                         data: .constant([
